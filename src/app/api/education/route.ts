...
export async function GET(req: Request) {
    try {
        ...
        return NextResponse.json([
            { "id": 1, "title": "Chechen State University", "subject": "Software Engineering", "term": "2021-2025" },
            { "id": 7, "title": "Self-education, Computer courses", "subject": "Programming, Design, 3D", "term": "2016 - today" }]);
    }
}
